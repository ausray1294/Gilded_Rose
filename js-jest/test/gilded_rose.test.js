...
describe('Gilded Rose Pin Down Tests', () => {
  ...
  describe('should accurately update the normal items', () => {
  ...
  describe('should accurately update "Aged Brie" when updateAgedBrie is called', () => {
  ...
  describe("should accurately update the 'Backstage Passes' when updateBackstagePasses is called", () => {
  ...
  describe("should not do anything to 'Sulfuras' when checkNameFunction is called", () => {
